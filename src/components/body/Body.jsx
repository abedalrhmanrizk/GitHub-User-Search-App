...
import { formatApiDate } from '../../../lib/utility';

function Body({ data, isLoading, error }) {
  if (error) return <div>failed to load</div>;
  if (isLoading) return <div>loading...</div>;
  const dataJoin = formatApiDate(data.created_at);
  return (
    <section>
      <div className={styles.header}>
        ...
        <div className={styles.accountDetails}>
          ...
          <p className={styles.joinDate}>{dataJoin}</p>
        </div>
      </div>
